...
describe('rankMemories', () => {
  ...
  it('scores higher for more important memories', () => {
    ...
    const memories = [
      makeMemory({ id: 'low-imp', similarity: 0.7, importance: 0.1, created_at: now }),
      makeMemory({ id: 'high-imp', similarity: 0.7, importance: 1.0, created_at: now }),
    ];
  ...
  it('scores higher for more recent memories', () => {
    ...
    const memories = [
      makeMemory({ id: 'old', similarity: 0.7, importance: 0.5, created_at: oldDate.toISOString() }),
      makeMemory({ id: 'new', similarity: 0.7, importance: 0.5, created_at: now.toISOString() }),
    ];
  ...
  it('scores higher for frequently accessed memories', () => {
    const now = new Date().toISOString();
    const memories = [
      makeMemory({ id: 'low-freq', similarity: 0.7, importance: 0.5, access_count: 1, created_at: now }),
      makeMemory({ id: 'high-freq', similarity: 0.7, importance: 0.5, access_count: 100, created_at: now }),
    ];
...
describe('rankFacts', () => {
  ...
  it('scores higher for more important facts', () => {
    const now = new Date().toISOString();
    const facts = [
      makeFact({ id: 'low-imp', similarity: 0.7, importance: 0.1, created_at: now }),
      makeFact({ id: 'high-imp', similarity: 0.7, importance: 1.0, created_at: now }),
    ];
  ...
  it('scores higher for more recent facts', () => {
    ...
    const facts = [
      makeFact({ id: 'old', similarity: 0.7, importance: 0.5, created_at: oldDate.toISOString() }),
      makeFact({ id: 'new', similarity: 0.7, importance: 0.5, created_at: now.toISOString() }),
    ];
