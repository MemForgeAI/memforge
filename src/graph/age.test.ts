...
describe("parseAgtype", () => {
  it("parses a vertex", () => {
    const raw =
      '{"id": 844424930131969, "label": "Entity", "properties": {"name": "Tokyo", "type": "location"}}::vertex';
  ...
  it("parses an edge", () => {
    const raw =
      '{"id": 1125899906842625, "label": "MENTIONS", "end_id": 844424930131969, "start_id": 844424930131970, "properties": {}}::edge';
    const result = parseAgtype(raw);
